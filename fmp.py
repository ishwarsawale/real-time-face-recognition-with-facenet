...
savvy_image = face_recognition.load_image_file("/Users/ishwarsawale/real-time-face-recognition-with-facenet/out_dir/Savvy Jain/frame118.png")
savvy_face_encoding = face_recognition.face_encodings(ishwar_image)[0]
